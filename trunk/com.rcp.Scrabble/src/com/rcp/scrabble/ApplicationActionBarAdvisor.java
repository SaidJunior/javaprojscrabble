...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		home = new Action(){
			public void run(){
				View.w.setBackgroundImage(new Image(View.w.display, resConfig.getImageStream("wooden_table.jpg")));
			}
		};
		home.setText("Home Sweet Home");
		space = new Action(){
			public void run(){
				View.w.setBackgroundImage(new Image(View.w.display, resConfig.getImageStream("space.jpg")));
			}
		};
		space.setText("In Space");
		beach = new Action(){
			public void run(){
				View.w.setBackgroundImage(new Image(View.w.display, resConfig.getImageStream("beach.jpg")));
		...
		forest = new Action(){
			public void run(){
				View.w.setBackgroundImage(new Image(View.w.display, resConfig.getImageStream("forest.jpg")));
