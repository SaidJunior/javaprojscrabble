 ...
 *
 */
public class MainWindow_ver2 extends org.eclipse.swt.widgets.Composite {
...
//	private Menu menuMulti;
	...
	*/
	...
	//	display.setWarnings(false);
		...
		MainWindow_ver2 inst = new MainWindow_ver2(shell, SWT.NULL);
...
//		shell.setSize(1200, 750);
		...
		shell.setImage(Images.getImage("scrabble_icon.png"));
...
//		}
		Image img = (Images.getImage("wooden_table.jpg"));
...
//				System.out.println("shell.shellClosed, event="+evt);
				...
				String message = ("Game Exit");
				 ...
				 options[0]="YES";
				 options[1]="NO";
				MessageDialog m = new MessageDialog(shell,title,null,message,MessageDialog.QUESTION,options,1);
...
//									System.out.println("menuItemViewHome.widgetSelected, event="+evt);
									Image image =(Images.getImage("wooden_table.jpg"));
...
//									System.out.println("menuItemViewBeach.widgetSelected, event="+evt);
									Image image = (Images.getImage("beach.jpg"));
									shell.setBackgroundImage(image);
								}
							});
						}
						{
							...
							menuItemViewSpace.addSelectionListener(new SelectionAdapter() {
								public void widgetSelected(SelectionEvent evt) {
									Image image = (Images.getImage("space.jpg"));
									shell.setBackgroundImage(image);
								}
							});
						}
...
//									System.out.println("menuItemViewForest.widgetSelected, event="+evt);
									Image image = (Images.getImage("forest.jpg"));
			...
			}
			{
				...
				lettersLeftLabelLData.left =  new FormAttachment(0, 1000, 154);
				lettersLeftLabelLData.top =  new FormAttachment(0, 1000, 565);
...
//				letterStandLabel.setImage(SWTResourceManager.getImage("lettersStand.PNG"));
				...
				letterStandLabel.setToolTipText("Your letter bank");
				{
					...
					playerLetter0.setBackgroundImage(Images.getImage("A.PNG"));
...
//							System.out.println("playerLetter7.mouseDown, event="+evt);
			...
			}
			{
				...
				groupNowPlayingLData.width = 190;
				groupNowPlayingLData.height = 30;
				groupNowPlayingLData.left =  new FormAttachment(0, 1000, 0);
				groupNowPlayingLData.top =  new FormAttachment(0, 1000, 8);
				groupNowPlaying.setLayoutData(groupNowPlayingLData);
				groupNowPlaying.setFont(SWTResourceManager.getFont("Tahoma",10,0,false,false));
				groupNowPlaying.setToolTipText("Current Player");
				{
					...
					textNowPlatingLData.widthHint = 180;
					textNowPlatingLData.heightHint = 25;
					textNowPlaying.setLayoutData(textNowPlatingLData);
					textNowPlaying.setBackground(SWTResourceManager.getColor(236, 233, 216));
					textNowPlaying.setFont(SWTResourceManager.getFont("Tahoma",10,0,false,false));
...
//				GridData lettersLeftButLData = new GridData();
				lettersLeftButLData.width = 146;
				lettersLeftButLData.height = 33;
				lettersLeftButLData.left =  new FormAttachment(0, 1000, 8);
				lettersLeftButLData.top =  new FormAttachment(0, 1000, 565);
			...
			}
			{
				...
				doneButLData.height = 72;
				doneButLData.left =  new FormAttachment(0, 1000, 8);
				doneButLData.top =  new FormAttachment(0, 1000, 612);
			...
			}
			{
				...
				changeLetterButLData.width = 107;
				changeLetterButLData.height = 72;
				changeLetterButLData.left =  new FormAttachment(0, 1000, 166);
				changeLetterButLData.top =  new FormAttachment(0, 1000, 612);
			...
			}
			{
				...
				cLabelBoard.setImage(Images.getImage("board.PNG"));
	...
	private void saveBeforExitMessage() {
		if (!isMulti){
			...
			options[0]="YES";
			options[1]="NO";
			MessageDialog messageBox = new MessageDialog(shell, title,null,message,MessageDialog.WARNING,options,2);
			int response = messageBox.open();
			if (response == 0) {
				saveAction();
			}
...
//				if (currentCell.getBackgroundImage() == null) {
					if (letter == '*') {
						...
						currentCell.setBackground(Images.getImage(l + "1.PNG"));
						currentCell.setBackgroundImage(Images.getImage(l + "1.PNG"));
						currentCell.setText("");
					}
				}
//				else {
...
//		}
	...
	private Image getLetterImage(char letter) {
		return (Images.getImage(String.valueOf(letter).toUpperCase() + ".PNG"));
	}
...
//			setPlayStatusText("The current turn is an auto player turn, press Done for him to make his move");
	...
	private void updateAfterUnSucInsert() {
	 ...
	 public void loadImages(){
         cLabelBoard.setBackgroundImage(Images.getImage("board.PNG"));
         letterStandLabel.setBackgroundImage(Images.getImage("lettersStand.PNG"));
         letterSetImageLabel.setBackground(Images.getImage("LetterSet.jpg"));
 }
...
//				updateWindow(false);
	...
	public void RecordListBasicSelected() {
		RLDialog rlDialog = new RLDialog(shell, true);
		rlDialog.open();
	}

	public void RecordListAdvancedSelected() {
